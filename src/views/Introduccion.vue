  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bloque-texto-g.color-acento-contenido.p-3.p-sm-4.p-md-5.mb-5
      ...
      .bloque-texto-g__texto.p-4(data-aos="fade-left")
        p.mb-0 <b>¿Sabía que la dispensación y distribución de medicamentos y dispositivos médicos son dos de los seis procesos generales del servicio farmacéutico?</b>
          br
          br
    ...
    p.mb-4(data-aos="fade-right") A continuación, se abordarán diferentes temas relacionados con ambos procesos que permitirán al lector ahondar en las particularidades de cada uno de ellos y comprender que tanto la dispensación como la distribución son actos profesionales propios de los farmacéuticos y son el origen del uso racional de los medicamentos. También se abordarán algunos puntos importantes de la administración de medicamentos que van unidos a toda la información anteriormente estudiada.
