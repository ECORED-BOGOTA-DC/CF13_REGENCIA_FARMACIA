    ...
    .tarjeta.p-4.mb-5(style="background-color: #FAFAFA")
      LineaTiempoC.color-secundario(text-small)
        .d-flex.flex-wrap(titulo="Elixir")
          img(src='@/assets/curso/temas/tema6/img-16.jpg' style="max-width: 295px" data-aos="fade-right" alt="Imagen decorativa")
        ...
        .d-flex.flex-wrap(titulo="Solución")
          img(src='@/assets/curso/temas/tema6/img-17.jpg' style="max-width: 295px" alt="Imagen decorativa")
          .col-md.ps-md-4
            h3.mb-4 Solución
        ...
        .d-flex.flex-wrap(titulo="Tintura")
          img(src='@/assets/curso/temas/tema6/img-18.jpg' style="max-width: 295px" alt="Imagen decorativa")
          .col-md.ps-md-4
            h3.mb-4 Tintura
        ...
        .d-flex.flex-wrap(titulo="Loción")
          img(src='@/assets/curso/temas/tema6/img-19.jpg' style="max-width: 295px" alt="Imagen decorativa")
          .col-md.ps-md-4
            h3.mb-4 Loción
        ...
        .d-flex.flex-wrap(titulo="Colirio")
          img(src='@/assets/curso/temas/tema6/img-20.jpg' style="max-width: 295px" alt="Imagen decorativa")
          .col-md.ps-md-4
            h3.mb-4 Colirio
            p Son preparaciones estériles con fines oftalmológicos.
        .d-flex.flex-wrap(titulo="Enema")
          img(src='@/assets/curso/temas/tema6/img-21.jpg' style="max-width: 295px" alt="Imagen decorativa")
          .col-md.ps-md-4
            h3.mb-4 Enema
        ...
        .d-flex.flex-wrap(titulo="Inyectable")
          img(src='@/assets/curso/temas/tema6/img-22.jpg' style="max-width: 295px" alt="Imagen decorativa")
          .col-md.ps-md-4
            h3.mb-4 Inyectable
        ...
        .d-flex.flex-wrap(titulo="Linimento")
          img(src='@/assets/curso/temas/tema6/img-23.jpg' style="max-width: 295px" alt="Imagen decorativa")
          .col-md.ps-md-4
            h3.mb-4 Linimento
        ...
        .d-flex.flex-wrap(titulo="Jarabe")
          img(src='@/assets/curso/temas/tema6/img-24.jpg' style="max-width: 295px" alt="Imagen decorativa")
          .col-md.ps-md-4
            h3.mb-4 Jarabe
    ...
    .tarjeta.p-4.mb-5(style="background-color: #FAFAFA")
      LineaTiempoC.color-secundario(text-small)
        .d-flex.flex-wrap(titulo="Oral")
          img.mb-auto(src='@/assets/curso/temas/tema6/img-30.jpg' style="max-width: 295px" data-aos="fade-right" alt="Imagen decorativa")
          .col-md.ps-md-4(data-aos="fade-left")
