  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    ul.mb-5
      li.d-flex.align-items-start.mb-3
        ...
        p.mb-0(data-aos="fade-left") Capacidad técnico-administrativa.
      li.d-flex.align-items-start.mb-3
        img.me-2(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 15px; margin-top: 5px" data-aos="fade-right")
        p.mb-0(data-aos="fade-left") Suficiencia patrimonial y financiera.
      li.d-flex.align-items-start.mb-3
        img.me-2(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 15px; margin-top: 5px" data-aos="fade-right")
          ...
          .col-md-5
            ...
            ul
              li.d-flex.align-items-start.mb-3
                ...
                p.mb-0 Para las preparaciones magistrales se debe contar con un área para el almacenamiento de las materias primas.
              li.d-flex.align-items-start.mb-3
                img.me-2(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 15px; margin-top: 5px")
    ...
    ul.ps-lg-5
      li.d-flex.align-items-start.mb-3
        img.me-2(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 15px; margin-top: 5px" data-aos="fade-right")
        p.mb-0(data-aos="fade-left")  Condiciones de almacenamiento.
      li.d-flex.align-items-start.mb-3
        img.me-2(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 15px; margin-top: 5px" data-aos="fade-right")
        p.mb-0(data-aos="fade-left") Forma adecuada de reconstituir medicamentos que lo requieran.
      li.d-flex.align-items-start.mb-3
        img.me-2(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 15px; margin-top: 5px" data-aos="fade-right")
    ...
    ol.lista-ol.lista-ol--separador.col-lg-10.mx-auto
      li(data-aos="fade-right")
        span.text-bold 1.
        | La prescripción correcta de los medicamentos por parte del médico.
      li(data-aos="fade-right")
        span.text-bold 2.
      ...
      .col-lg-4.col-xl-3
        ...
        .d-flex.align-items-center.mb-4
          .container-pill
            img(src="@/assets/curso/temas/tema2/decorador-1.svg")
            span 2
          p.mb-0.ps-3(data-aos="fade-right") Informar al médico todos los tratamientos que se estén tomando antes de iniciar el nuevo; ya sean homeopáticos, vitamínicos o remedios herbolarios.
        .d-flex.align-items-center.mb-4
          .container-pill
            img(src="@/assets/curso/temas/tema2/decorador-1.svg")
            span 3
          p.mb-0.ps-3(data-aos="fade-right") No modificar la dosis indicada por el médico tratante.
        .d-flex.align-items-center.mb-4
          .container-pill
            img(src="@/assets/curso/temas/tema2/decorador-1.svg")
            span 4
          p.mb-0.ps-3(data-aos="fade-right")  Si está embarazada o amamantando, consultar al médico antes de tomar medicamentos.
        .d-flex.align-items-center.mb-4
          .container-pill
            img(src="@/assets/curso/temas/tema2/decorador-1.svg")
            span 5
      ...
      .col-lg-4.col-xl-3
        .d-flex.align-items-center.mb-4
          .container-pill
            img(src="@/assets/curso/temas/tema2/decorador-1.svg")
            span 6
          p.mb-0.ps-3(data-aos="fade-right") Terminar el tratamiento como lo indica el médico en la receta.
        .d-flex.align-items-center.mb-4
          .container-pill
            img(src="@/assets/curso/temas/tema2/decorador-1.svg")
            span 7
          p.mb-0.ps-3(data-aos="fade-right") No automedicarse, agregar o remplazar medicamentos al tratamiento ya establecido por el médico.
        .d-flex.align-items-center.mb-4
          .container-pill
            img(src="@/assets/curso/temas/tema2/decorador-1.svg")
            span 8
          p.mb-0.ps-3(data-aos="fade-right") Mencionar al médico cualquier malestar o síntoma que aparezca después de tomar los medicamentos.
        .d-flex.align-items-center.mb-4
          .container-pill
            img(src="@/assets/curso/temas/tema2/decorador-1.svg")
            span 9
          p.mb-0.ps-3(data-aos="fade-right") Almacenar los medicamentos lejos de una fuente de calor, humedad o luz intensa.
        .d-flex.align-items-center.mb-4
          .container-pill
            img(src="@/assets/curso/temas/tema2/decorador-1.svg")
            span 10
    ...
    ul.mb-5
      li.d-flex.align-items-start.mb-3
        img.me-2(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 15px; margin-top: 5px" data-aos="fade-right")
        p.mb-0(data-aos="fade-left") Riesgos al suspender el tratamiento.
      li.d-flex.align-items-start.mb-3
        img.me-2(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 15px; margin-top: 5px" data-aos="fade-right")
        p.mb-0(data-aos="fade-left") Modo de uso de los dispositivos médicos.
      li.d-flex.align-items-start.mb-3
        img.me-2(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 15px; margin-top: 5px" data-aos="fade-right")
    ...
    ul
      li.d-flex.align-items-start.mb-3
        img.me-2(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 15px; margin-top: 5px" data-aos="fade-right")
        p.mb-0(data-aos="fade-left") Formulario Terapéutico nacional.
      li.d-flex.align-items-start.mb-3
        img.me-2(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 15px; margin-top: 5px" data-aos="fade-right")
        p.mb-0(data-aos="fade-left") Vademécum de especialidades farmacéuticas.
      li.d-flex.align-items-start.mb-3
        img.me-2(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 15px; margin-top: 5px" data-aos="fade-right")
        p.mb-0(data-aos="fade-left") Información completa de los medicamentos creada por la institución.
      li.d-flex.align-items-start.mb-3
        img.me-2(src='@/assets/curso/temas/decorador-1.svg' style="max-width: 15px; margin-top: 5px" data-aos="fade-right")
        p.mb-0(data-aos="fade-left") Textos farmacológicos.
